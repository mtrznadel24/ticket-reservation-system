...
urlpatterns = [
    ...
    path("my-orders/<int:order_id>/", views.OrderDetailsView.as_view(), name="order_details"),
    ...
    path("cart/remove_ticket/<int:ticket_id>/", views.remove_from_cart_view, name="remove_from_cart"),
